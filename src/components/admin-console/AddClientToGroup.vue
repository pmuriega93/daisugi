...
const clientsWithNoGroup = computed(() => clients.value?.filter(cl => !cl.audiences || cl.audiences.length === 0 || cl.audiences?.some(a => a.id !== route.params.id)))
</script>
<template>
